...
/* Definitions for ServoSemaphore */
osSemaphoreId_t ServoSemaphoreHandle;
const osSemaphoreAttr_t ServoSemaphore_attributes = {
  .name = "ServoSemaphore"
};
/* Definitions for LCDSemaphore */
osSemaphoreId_t LCDSemaphoreHandle;
const osSemaphoreAttr_t LCDSemaphore_attributes = {
  .name = "LCDSemaphore"
};

volatile uint8_t hand_detected = 0;
